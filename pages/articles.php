...
<br>
  ...
  <div class="container-fluid">
    <section>
        <div class="container-fluid" class="articlesBorder">
            <div class="card">
                <div class="row " id="articlesBorder">
                    <div class="col-md-4">
                        <img src="components/pussboilogo.png"
                            class="cardclass">
                    </div>
            ...
            <div class="card">
                <div class="row " id="articlesBorder">
                    ...
                    <div class="col-md-8 px-3">
                        <div class="card-block px-3">
                            <a href="?page=2">Article1</a>
                            <p class="card-text">Cats in Ancient Egypt
...
<div class="container-fluid">
    <section>
        <div class="container-fluid">
            <div class="card">
                <div class="row "  id="articlesBorder">
                    <div class="col-md-4" id="articlePicture">
                        <img src="components/pussboilogo.png"
                            class="cardclass">
                    </div>
                    <div class="col-md-8 px-3">
...
<div class="container-fluid" id="pagination-position">
	<div class="row">
		<div class="col-md-12" id="pagination-background">
			<nav>
				<ul class="pagination">
					<li class="page-item">
